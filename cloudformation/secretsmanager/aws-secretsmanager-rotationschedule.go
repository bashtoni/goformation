...
func (r *RotationSchedule) UnmarshalJSON(b []byte) error {
	type P RotationSchedule
	props := &RotationSchedule{}
	newProps := &struct {
		*P
		RotationLambdaARN types.StringIsh `json:"RotationLambdaARN,omitempty"`
		SecretId          types.StringIsh `json:"SecretId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.RotationLambdaARN = string(newProps.RotationLambdaARN)
		props.SecretId = string(newProps.SecretId)
