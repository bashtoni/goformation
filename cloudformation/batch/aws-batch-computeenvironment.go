...
func (r *ComputeEnvironment) UnmarshalJSON(b []byte) error {
	type P ComputeEnvironment
	props := &ComputeEnvironment{}
	newProps := &struct {
		*P
		ComputeEnvironmentName types.StringIsh `json:"ComputeEnvironmentName,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ComputeEnvironmentName = string(newProps.ComputeEnvironmentName)
