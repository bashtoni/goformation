...
func (r *Dashboard) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		DashboardBody types.StringIsh `json:"DashboardBody,omitempty"`
		DashboardName types.StringIsh `json:"DashboardName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.DashboardBody = string(newProps.DashboardBody)
		props.DashboardName = string(newProps.DashboardName)
