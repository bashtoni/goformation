...
func (r *Trigger) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		Schedule     types.StringIsh `json:"Schedule,omitempty"`
		Type         types.StringIsh `json:"Type,omitempty"`
		WorkflowName types.StringIsh `json:"WorkflowName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.Schedule = string(newProps.Schedule)
		props.Type = string(newProps.Type)
		props.WorkflowName = string(newProps.WorkflowName)
