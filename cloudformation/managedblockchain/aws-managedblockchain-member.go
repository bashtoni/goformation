...
func (r *Member) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		InvitationId types.StringIsh `json:"InvitationId,omitempty"`
		NetworkId    types.StringIsh `json:"NetworkId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.InvitationId = string(newProps.InvitationId)
		props.NetworkId = string(newProps.NetworkId)
