...
func (r *EndpointConfig) UnmarshalJSON(b []byte) error {
	type P EndpointConfig
	props := &EndpointConfig{}
	newProps := &struct {
		*P
		EndpointConfigName types.StringIsh `json:"EndpointConfigName,omitempty"`
	...
	if res.Properties != nil {
		...
		props.EndpointConfigName = string(newProps.EndpointConfigName)
