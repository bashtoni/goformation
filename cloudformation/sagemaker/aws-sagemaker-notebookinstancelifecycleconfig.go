...
func (r *NotebookInstanceLifecycleConfig) UnmarshalJSON(b []byte) error {
	type P NotebookInstanceLifecycleConfig
	props := &NotebookInstanceLifecycleConfig{}
	newProps := &struct {
		*P
		NotebookInstanceLifecycleConfigName types.StringIsh `json:"NotebookInstanceLifecycleConfigName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.NotebookInstanceLifecycleConfigName = string(newProps.NotebookInstanceLifecycleConfigName)
