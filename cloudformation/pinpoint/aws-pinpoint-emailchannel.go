...
func (r *EmailChannel) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		ConfigurationSet types.StringIsh `json:"ConfigurationSet,omitempty"`
		FromAddress      types.StringIsh `json:"FromAddress,omitempty"`
		Identity         types.StringIsh `json:"Identity,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ConfigurationSet = string(newProps.ConfigurationSet)
		props.FromAddress = string(newProps.FromAddress)
		props.Identity = string(newProps.Identity)
