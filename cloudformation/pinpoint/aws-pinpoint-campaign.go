...
func (r *Campaign) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		SegmentId            types.StringIsh `json:"SegmentId,omitempty"`
		TreatmentDescription types.StringIsh `json:"TreatmentDescription,omitempty"`
		TreatmentName        types.StringIsh `json:"TreatmentName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.SegmentId = string(newProps.SegmentId)
		props.TreatmentDescription = string(newProps.TreatmentDescription)
		props.TreatmentName = string(newProps.TreatmentName)
