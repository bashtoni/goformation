...
func (r *EmailTemplate) UnmarshalJSON(b []byte) error {
	type P EmailTemplate
	props := &EmailTemplate{}
	newProps := &struct {
		*P
		DefaultSubstitutions types.StringIsh `json:"DefaultSubstitutions,omitempty"`
		HtmlPart             types.StringIsh `json:"HtmlPart,omitempty"`
		Subject              types.StringIsh `json:"Subject,omitempty"`
		TemplateDescription  types.StringIsh `json:"TemplateDescription,omitempty"`
		TemplateName         types.StringIsh `json:"TemplateName,omitempty"`
		TextPart             types.StringIsh `json:"TextPart,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.DefaultSubstitutions = string(newProps.DefaultSubstitutions)
		props.HtmlPart = string(newProps.HtmlPart)
		props.Subject = string(newProps.Subject)
		props.TemplateDescription = string(newProps.TemplateDescription)
		props.TemplateName = string(newProps.TemplateName)
		props.TextPart = string(newProps.TextPart)
