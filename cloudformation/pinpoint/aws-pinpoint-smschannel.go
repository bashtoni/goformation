...
func (r *SMSChannel) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		SenderId      types.StringIsh `json:"SenderId,omitempty"`
		ShortCode     types.StringIsh `json:"ShortCode,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.SenderId = string(newProps.SenderId)
		props.ShortCode = string(newProps.ShortCode)
