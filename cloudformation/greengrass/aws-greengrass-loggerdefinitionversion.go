...
func (r *LoggerDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P LoggerDefinitionVersion
	props := &LoggerDefinitionVersion{}
	newProps := &struct {
		*P
		LoggerDefinitionId types.StringIsh `json:"LoggerDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.LoggerDefinitionId = string(newProps.LoggerDefinitionId)
