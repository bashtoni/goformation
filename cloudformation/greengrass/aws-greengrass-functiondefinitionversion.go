...
func (r *FunctionDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P FunctionDefinitionVersion
	props := &FunctionDefinitionVersion{}
	newProps := &struct {
		*P
		FunctionDefinitionId types.StringIsh `json:"FunctionDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.FunctionDefinitionId = string(newProps.FunctionDefinitionId)
