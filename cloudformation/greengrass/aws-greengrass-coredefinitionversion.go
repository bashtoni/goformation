...
func (r *CoreDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P CoreDefinitionVersion
	props := &CoreDefinitionVersion{}
	newProps := &struct {
		*P
		CoreDefinitionId types.StringIsh `json:"CoreDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.CoreDefinitionId = string(newProps.CoreDefinitionId)
