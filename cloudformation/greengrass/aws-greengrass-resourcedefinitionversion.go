...
func (r *ResourceDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P ResourceDefinitionVersion
	props := &ResourceDefinitionVersion{}
	newProps := &struct {
		*P
		ResourceDefinitionId types.StringIsh `json:"ResourceDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ResourceDefinitionId = string(newProps.ResourceDefinitionId)
