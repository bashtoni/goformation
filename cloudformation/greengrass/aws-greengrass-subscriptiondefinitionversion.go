...
func (r *SubscriptionDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P SubscriptionDefinitionVersion
	props := &SubscriptionDefinitionVersion{}
	newProps := &struct {
		*P
		SubscriptionDefinitionId types.StringIsh `json:"SubscriptionDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.SubscriptionDefinitionId = string(newProps.SubscriptionDefinitionId)
