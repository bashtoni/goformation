...
func (r *DeviceDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P DeviceDefinitionVersion
	props := &DeviceDefinitionVersion{}
	newProps := &struct {
		*P
		DeviceDefinitionId types.StringIsh `json:"DeviceDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.DeviceDefinitionId = string(newProps.DeviceDefinitionId)
