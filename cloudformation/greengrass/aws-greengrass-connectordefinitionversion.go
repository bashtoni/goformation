...
func (r *ConnectorDefinitionVersion) UnmarshalJSON(b []byte) error {
	type P ConnectorDefinitionVersion
	props := &ConnectorDefinitionVersion{}
	newProps := &struct {
		*P
		ConnectorDefinitionId types.StringIsh `json:"ConnectorDefinitionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConnectorDefinitionId = string(newProps.ConnectorDefinitionId)
