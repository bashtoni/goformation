...
func (r *Application) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ApplicationDescription types.StringIsh `json:"ApplicationDescription,omitempty"`
		ApplicationName        types.StringIsh `json:"ApplicationName,omitempty"`
		RuntimeEnvironment     types.StringIsh `json:"RuntimeEnvironment,omitempty"`
		ServiceExecutionRole   types.StringIsh `json:"ServiceExecutionRole,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ApplicationDescription = string(newProps.ApplicationDescription)
		props.ApplicationName = string(newProps.ApplicationName)
		props.RuntimeEnvironment = string(newProps.RuntimeEnvironment)
		props.ServiceExecutionRole = string(newProps.ServiceExecutionRole)
