...
func (r *Channel) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ChannelClass types.StringIsh `json:"ChannelClass,omitempty"`
		LogLevel     types.StringIsh `json:"LogLevel,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ChannelClass = string(newProps.ChannelClass)
		props.LogLevel = string(newProps.LogLevel)
