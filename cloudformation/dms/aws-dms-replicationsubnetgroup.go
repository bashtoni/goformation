...
func (r *ReplicationSubnetGroup) UnmarshalJSON(b []byte) error {
	type P ReplicationSubnetGroup
	props := &ReplicationSubnetGroup{}
	newProps := &struct {
		*P
		ReplicationSubnetGroupDescription types.StringIsh `json:"ReplicationSubnetGroupDescription,omitempty"`
		ReplicationSubnetGroupIdentifier  types.StringIsh `json:"ReplicationSubnetGroupIdentifier,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ReplicationSubnetGroupDescription = string(newProps.ReplicationSubnetGroupDescription)
		props.ReplicationSubnetGroupIdentifier = string(newProps.ReplicationSubnetGroupIdentifier)
