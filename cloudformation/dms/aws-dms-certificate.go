...
func (r *Certificate) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		CertificateIdentifier types.StringIsh `json:"CertificateIdentifier,omitempty"`
		CertificatePem        types.StringIsh `json:"CertificatePem,omitempty"`
		CertificateWallet     types.StringIsh `json:"CertificateWallet,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.CertificateIdentifier = string(newProps.CertificateIdentifier)
		props.CertificatePem = string(newProps.CertificatePem)
		props.CertificateWallet = string(newProps.CertificateWallet)
