...
func (r *Topic) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		KmsMasterKeyId types.StringIsh `json:"KmsMasterKeyId,omitempty"`
		TopicName      types.StringIsh `json:"TopicName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.KmsMasterKeyId = string(newProps.KmsMasterKeyId)
		props.TopicName = string(newProps.TopicName)
