...
func (r *SourceCredential) UnmarshalJSON(b []byte) error {
	type P SourceCredential
	props := &SourceCredential{}
	newProps := &struct {
		*P
		AuthType   types.StringIsh `json:"AuthType,omitempty"`
		ServerType types.StringIsh `json:"ServerType,omitempty"`
		Token      types.StringIsh `json:"Token,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ServerType = string(newProps.ServerType)
		props.Token = string(newProps.Token)
