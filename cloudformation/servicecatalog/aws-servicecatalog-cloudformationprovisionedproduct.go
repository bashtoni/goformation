...
func (r *CloudFormationProvisionedProduct) UnmarshalJSON(b []byte) error {
	type P CloudFormationProvisionedProduct
	props := &CloudFormationProvisionedProduct{}
	newProps := &struct {
		*P
		AcceptLanguage           types.StringIsh `json:"AcceptLanguage,omitempty"`
		PathId                   types.StringIsh `json:"PathId,omitempty"`
		ProductId                types.StringIsh `json:"ProductId,omitempty"`
		ProductName              types.StringIsh `json:"ProductName,omitempty"`
		ProvisionedProductName   types.StringIsh `json:"ProvisionedProductName,omitempty"`
		ProvisioningArtifactId   types.StringIsh `json:"ProvisioningArtifactId,omitempty"`
		ProvisioningArtifactName types.StringIsh `json:"ProvisioningArtifactName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.PathId = string(newProps.PathId)
		props.ProductId = string(newProps.ProductId)
		props.ProductName = string(newProps.ProductName)
		props.ProvisionedProductName = string(newProps.ProvisionedProductName)
		props.ProvisioningArtifactId = string(newProps.ProvisioningArtifactId)
		props.ProvisioningArtifactName = string(newProps.ProvisioningArtifactName)
