...
func (r *TagOptionAssociation) UnmarshalJSON(b []byte) error {
	type P TagOptionAssociation
	props := &TagOptionAssociation{}
	newProps := &struct {
		*P
		ResourceId  types.StringIsh `json:"ResourceId,omitempty"`
		TagOptionId types.StringIsh `json:"TagOptionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.TagOptionId = string(newProps.TagOptionId)
