...
func (r *StackSetConstraint) UnmarshalJSON(b []byte) error {
	type P StackSetConstraint
	props := &StackSetConstraint{}
	newProps := &struct {
		*P
		AcceptLanguage       types.StringIsh `json:"AcceptLanguage,omitempty"`
		AdminRole            types.StringIsh `json:"AdminRole,omitempty"`
		Description          types.StringIsh `json:"Description,omitempty"`
		ExecutionRole        types.StringIsh `json:"ExecutionRole,omitempty"`
		PortfolioId          types.StringIsh `json:"PortfolioId,omitempty"`
		ProductId            types.StringIsh `json:"ProductId,omitempty"`
		StackInstanceControl types.StringIsh `json:"StackInstanceControl,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AdminRole = string(newProps.AdminRole)
		props.Description = string(newProps.Description)
		props.ExecutionRole = string(newProps.ExecutionRole)
		props.PortfolioId = string(newProps.PortfolioId)
		props.ProductId = string(newProps.ProductId)
		props.StackInstanceControl = string(newProps.StackInstanceControl)
