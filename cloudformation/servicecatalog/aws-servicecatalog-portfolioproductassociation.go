...
func (r *PortfolioProductAssociation) UnmarshalJSON(b []byte) error {
	type P PortfolioProductAssociation
	props := &PortfolioProductAssociation{}
	newProps := &struct {
		*P
		...
		SourcePortfolioId types.StringIsh `json:"SourcePortfolioId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.SourcePortfolioId = string(newProps.SourcePortfolioId)
