...
func (r *CloudFormationProduct) UnmarshalJSON(b []byte) error {
	type P CloudFormationProduct
	props := &CloudFormationProduct{}
	newProps := &struct {
		*P
		AcceptLanguage     types.StringIsh `json:"AcceptLanguage,omitempty"`
		Description        types.StringIsh `json:"Description,omitempty"`
		Distributor        types.StringIsh `json:"Distributor,omitempty"`
		Name               types.StringIsh `json:"Name,omitempty"`
		Owner              types.StringIsh `json:"Owner,omitempty"`
		SupportDescription types.StringIsh `json:"SupportDescription,omitempty"`
		SupportEmail       types.StringIsh `json:"SupportEmail,omitempty"`
		SupportUrl         types.StringIsh `json:"SupportUrl,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.Distributor = string(newProps.Distributor)
		props.Name = string(newProps.Name)
		props.Owner = string(newProps.Owner)
		props.SupportDescription = string(newProps.SupportDescription)
		props.SupportEmail = string(newProps.SupportEmail)
		props.SupportUrl = string(newProps.SupportUrl)
