...
func (r *UserPoolResourceServer) UnmarshalJSON(b []byte) error {
	type P UserPoolResourceServer
	props := &UserPoolResourceServer{}
	newProps := &struct {
		*P
		Identifier types.StringIsh `json:"Identifier,omitempty"`
	...
	if res.Properties != nil {
		...
		props.Identifier = string(newProps.Identifier)
