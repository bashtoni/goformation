...
func (r *IdentityPoolRoleAttachment) UnmarshalJSON(b []byte) error {
	type P IdentityPoolRoleAttachment
	props := &IdentityPoolRoleAttachment{}
	newProps := &struct {
		*P
		IdentityPoolId types.StringIsh `json:"IdentityPoolId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.IdentityPoolId = string(newProps.IdentityPoolId)
