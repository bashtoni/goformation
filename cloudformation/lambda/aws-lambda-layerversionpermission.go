...
func (r *LayerVersionPermission) UnmarshalJSON(b []byte) error {
	type P LayerVersionPermission
	props := &LayerVersionPermission{}
	newProps := &struct {
		*P
		Action          types.StringIsh `json:"Action,omitempty"`
		LayerVersionArn types.StringIsh `json:"LayerVersionArn,omitempty"`
		OrganizationId  types.StringIsh `json:"OrganizationId,omitempty"`
	...
	if res.Properties != nil {
		...
		props.LayerVersionArn = string(newProps.LayerVersionArn)
		props.OrganizationId = string(newProps.OrganizationId)
