...
func (r *Permission) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		EventSourceToken types.StringIsh `json:"EventSourceToken,omitempty"`
		FunctionName     types.StringIsh `json:"FunctionName,omitempty"`
		Principal        types.StringIsh `json:"Principal,omitempty"`
		SourceAccount    types.StringIsh `json:"SourceAccount,omitempty"`
		SourceArn        types.StringIsh `json:"SourceArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.EventSourceToken = string(newProps.EventSourceToken)
		props.FunctionName = string(newProps.FunctionName)
		props.Principal = string(newProps.Principal)
		props.SourceAccount = string(newProps.SourceAccount)
		props.SourceArn = string(newProps.SourceArn)
