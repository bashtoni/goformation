...
func (r *EventSourceMapping) UnmarshalJSON(b []byte) error {
	type P EventSourceMapping
	props := &EventSourceMapping{}
	newProps := &struct {
		*P
		EventSourceArn   types.StringIsh `json:"EventSourceArn,omitempty"`
		FunctionName     types.StringIsh `json:"FunctionName,omitempty"`
		StartingPosition types.StringIsh `json:"StartingPosition,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.EventSourceArn = string(newProps.EventSourceArn)
		props.FunctionName = string(newProps.FunctionName)
		props.StartingPosition = string(newProps.StartingPosition)
