...
func (r *ClusterParameterGroup) UnmarshalJSON(b []byte) error {
	type P ClusterParameterGroup
	props := &ClusterParameterGroup{}
	newProps := &struct {
		*P
		Description          types.StringIsh `json:"Description,omitempty"`
		ParameterGroupFamily types.StringIsh `json:"ParameterGroupFamily,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ParameterGroupFamily = string(newProps.ParameterGroupFamily)
