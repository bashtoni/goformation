...
func (r *Alias) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		AliasName   types.StringIsh `json:"AliasName,omitempty"`
		TargetKeyId types.StringIsh `json:"TargetKeyId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AliasName = string(newProps.AliasName)
		props.TargetKeyId = string(newProps.TargetKeyId)
