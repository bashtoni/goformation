...
func (r *CostCategory) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		RuleVersion types.StringIsh `json:"RuleVersion,omitempty"`
		Rules       types.StringIsh `json:"Rules,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.RuleVersion = string(newProps.RuleVersion)
		props.Rules = string(newProps.Rules)
