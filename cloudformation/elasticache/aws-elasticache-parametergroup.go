...
func (r *ParameterGroup) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		CacheParameterGroupFamily types.StringIsh `json:"CacheParameterGroupFamily,omitempty"`
	...
	if res.Properties != nil {
		...
		props.CacheParameterGroupFamily = string(newProps.CacheParameterGroupFamily)
