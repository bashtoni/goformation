...
func (r *DBProxyTargetGroup) UnmarshalJSON(b []byte) error {
	type P DBProxyTargetGroup
	props := &DBProxyTargetGroup{}
	newProps := &struct {
		*P
		DBProxyName     types.StringIsh `json:"DBProxyName,omitempty"`
		TargetGroupName types.StringIsh `json:"TargetGroupName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.DBProxyName = string(newProps.DBProxyName)
		props.TargetGroupName = string(newProps.TargetGroupName)
