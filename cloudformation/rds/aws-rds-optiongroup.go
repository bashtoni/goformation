...
func (r *OptionGroup) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		MajorEngineVersion     types.StringIsh `json:"MajorEngineVersion,omitempty"`
		OptionGroupDescription types.StringIsh `json:"OptionGroupDescription,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.MajorEngineVersion = string(newProps.MajorEngineVersion)
		props.OptionGroupDescription = string(newProps.OptionGroupDescription)
