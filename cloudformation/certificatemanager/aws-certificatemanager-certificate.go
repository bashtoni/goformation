...
func (r *Certificate) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		CertificateTransparencyLoggingPreference types.StringIsh `json:"CertificateTransparencyLoggingPreference,omitempty"`
		DomainName                               types.StringIsh `json:"DomainName,omitempty"`
		ValidationMethod                         types.StringIsh `json:"ValidationMethod,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.CertificateTransparencyLoggingPreference = string(newProps.CertificateTransparencyLoggingPreference)
		props.DomainName = string(newProps.DomainName)
		props.ValidationMethod = string(newProps.ValidationMethod)
