...
func (r *OrganizationConfigRule) UnmarshalJSON(b []byte) error {
	type P OrganizationConfigRule
	props := &OrganizationConfigRule{}
	newProps := &struct {
		*P
		OrganizationConfigRuleName types.StringIsh `json:"OrganizationConfigRuleName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.OrganizationConfigRuleName = string(newProps.OrganizationConfigRuleName)
