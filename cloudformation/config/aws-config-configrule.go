...
func (r *ConfigRule) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		MaximumExecutionFrequency types.StringIsh `json:"MaximumExecutionFrequency,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.MaximumExecutionFrequency = string(newProps.MaximumExecutionFrequency)
