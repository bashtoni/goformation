...
func (r *ConfigurationAggregator) UnmarshalJSON(b []byte) error {
	type P ConfigurationAggregator
	props := &ConfigurationAggregator{}
	newProps := &struct {
		*P
		ConfigurationAggregatorName types.StringIsh `json:"ConfigurationAggregatorName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConfigurationAggregatorName = string(newProps.ConfigurationAggregatorName)
