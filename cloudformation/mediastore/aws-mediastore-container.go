...
func (r *Container) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ContainerName   types.StringIsh `json:"ContainerName,omitempty"`
		LifecyclePolicy types.StringIsh `json:"LifecyclePolicy,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ContainerName = string(newProps.ContainerName)
		props.LifecyclePolicy = string(newProps.LifecyclePolicy)
