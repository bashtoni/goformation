...
func (r *Connection) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ConnectionName types.StringIsh `json:"ConnectionName,omitempty"`
		HostArn        types.StringIsh `json:"HostArn,omitempty"`
		ProviderType   types.StringIsh `json:"ProviderType,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConnectionName = string(newProps.ConnectionName)
		props.HostArn = string(newProps.HostArn)
		props.ProviderType = string(newProps.ProviderType)
