...
func (r *MaintenanceWindow) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		ScheduleTimezone types.StringIsh `json:"ScheduleTimezone,omitempty"`
		StartDate        types.StringIsh `json:"StartDate,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ScheduleTimezone = string(newProps.ScheduleTimezone)
		props.StartDate = string(newProps.StartDate)
