...
func (r *MaintenanceWindowTarget) UnmarshalJSON(b []byte) error {
	type P MaintenanceWindowTarget
	props := &MaintenanceWindowTarget{}
	newProps := &struct {
		*P
		Description      types.StringIsh `json:"Description,omitempty"`
		Name             types.StringIsh `json:"Name,omitempty"`
		OwnerInformation types.StringIsh `json:"OwnerInformation,omitempty"`
	...
	if res.Properties != nil {
		...
		props.OwnerInformation = string(newProps.OwnerInformation)
