...
func (r *PatchBaseline) UnmarshalJSON(b []byte) error {
	type P PatchBaseline
	props := &PatchBaseline{}
	newProps := &struct {
		*P
		ApprovedPatchesComplianceLevel types.StringIsh `json:"ApprovedPatchesComplianceLevel,omitempty"`
		Description                    types.StringIsh `json:"Description,omitempty"`
		Name                           types.StringIsh `json:"Name,omitempty"`
		OperatingSystem                types.StringIsh `json:"OperatingSystem,omitempty"`
		RejectedPatchesAction          types.StringIsh `json:"RejectedPatchesAction,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ApprovedPatchesComplianceLevel = string(newProps.ApprovedPatchesComplianceLevel)
		props.Description = string(newProps.Description)
		props.Name = string(newProps.Name)
		props.OperatingSystem = string(newProps.OperatingSystem)
		props.RejectedPatchesAction = string(newProps.RejectedPatchesAction)
