...
func (r *StateMachine) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		DefinitionString types.StringIsh `json:"DefinitionString,omitempty"`
		RoleArn          types.StringIsh `json:"RoleArn,omitempty"`
		StateMachineName types.StringIsh `json:"StateMachineName,omitempty"`
		StateMachineType types.StringIsh `json:"StateMachineType,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.DefinitionString = string(newProps.DefinitionString)
		props.RoleArn = string(newProps.RoleArn)
		props.StateMachineName = string(newProps.StateMachineName)
		props.StateMachineType = string(newProps.StateMachineType)
