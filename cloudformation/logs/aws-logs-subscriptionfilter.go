...
func (r *SubscriptionFilter) UnmarshalJSON(b []byte) error {
	type P SubscriptionFilter
	props := &SubscriptionFilter{}
	newProps := &struct {
		*P
		DestinationArn types.StringIsh `json:"DestinationArn,omitempty"`
		FilterPattern  types.StringIsh `json:"FilterPattern,omitempty"`
	...
	if res.Properties != nil {
		...
		props.DestinationArn = string(newProps.DestinationArn)
		props.FilterPattern = string(newProps.FilterPattern)
