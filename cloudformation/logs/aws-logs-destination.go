...
func (r *Destination) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		DestinationName   types.StringIsh `json:"DestinationName,omitempty"`
		DestinationPolicy types.StringIsh `json:"DestinationPolicy,omitempty"`
		RoleArn           types.StringIsh `json:"RoleArn,omitempty"`
		TargetArn         types.StringIsh `json:"TargetArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.DestinationName = string(newProps.DestinationName)
		props.DestinationPolicy = string(newProps.DestinationPolicy)
		props.RoleArn = string(newProps.RoleArn)
		props.TargetArn = string(newProps.TargetArn)
