...
func (r *LayerVersion) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ContentUri      types.StringIsh `json:"ContentUri,omitempty"`
		Description     types.StringIsh `json:"Description,omitempty"`
		LayerName       types.StringIsh `json:"LayerName,omitempty"`
		LicenseInfo     types.StringIsh `json:"LicenseInfo,omitempty"`
		RetentionPolicy types.StringIsh `json:"RetentionPolicy,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ContentUri = string(newProps.ContentUri)
		props.Description = string(newProps.Description)
		props.LayerName = string(newProps.LayerName)
		props.LicenseInfo = string(newProps.LicenseInfo)
		props.RetentionPolicy = string(newProps.RetentionPolicy)
