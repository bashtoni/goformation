...
func (r *Api) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		EndpointConfiguration types.StringIsh `json:"EndpointConfiguration,omitempty"`
		Name                  types.StringIsh `json:"Name,omitempty"`
		OpenApiVersion        types.StringIsh `json:"OpenApiVersion,omitempty"`
	...
	if res.Properties != nil {
		...
		props.EndpointConfiguration = string(newProps.EndpointConfiguration)
		props.Name = string(newProps.Name)
		props.OpenApiVersion = string(newProps.OpenApiVersion)
