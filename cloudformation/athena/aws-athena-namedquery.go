...
func (r *NamedQuery) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		Database    types.StringIsh `json:"Database,omitempty"`
		Description types.StringIsh `json:"Description,omitempty"`
		Name        types.StringIsh `json:"Name,omitempty"`
		QueryString types.StringIsh `json:"QueryString,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.Database = string(newProps.Database)
		props.Description = string(newProps.Description)
		props.Name = string(newProps.Name)
		props.QueryString = string(newProps.QueryString)
