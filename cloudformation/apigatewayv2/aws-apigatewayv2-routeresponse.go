...
func (r *RouteResponse) UnmarshalJSON(b []byte) error {
	type P RouteResponse
	props := &RouteResponse{}
	newProps := &struct {
		*P
		ApiId                    types.StringIsh `json:"ApiId,omitempty"`
		ModelSelectionExpression types.StringIsh `json:"ModelSelectionExpression,omitempty"`
		RouteId                  types.StringIsh `json:"RouteId,omitempty"`
		RouteResponseKey         types.StringIsh `json:"RouteResponseKey,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ModelSelectionExpression = string(newProps.ModelSelectionExpression)
		props.RouteId = string(newProps.RouteId)
		props.RouteResponseKey = string(newProps.RouteResponseKey)
