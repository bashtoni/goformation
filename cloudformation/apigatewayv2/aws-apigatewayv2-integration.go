...
func (r *Integration) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		ConnectionId                types.StringIsh `json:"ConnectionId,omitempty"`
		...
		IntegrationMethod           types.StringIsh `json:"IntegrationMethod,omitempty"`
		IntegrationType             types.StringIsh `json:"IntegrationType,omitempty"`
		IntegrationUri              types.StringIsh `json:"IntegrationUri,omitempty"`
		PassthroughBehavior         types.StringIsh `json:"PassthroughBehavior,omitempty"`
		PayloadFormatVersion        types.StringIsh `json:"PayloadFormatVersion,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ConnectionId = string(newProps.ConnectionId)
		...
		props.IntegrationMethod = string(newProps.IntegrationMethod)
		props.IntegrationType = string(newProps.IntegrationType)
		props.IntegrationUri = string(newProps.IntegrationUri)
		props.PassthroughBehavior = string(newProps.PassthroughBehavior)
		props.PayloadFormatVersion = string(newProps.PayloadFormatVersion)
