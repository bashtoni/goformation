...
func (r *ThreatIntelSet) UnmarshalJSON(b []byte) error {
	type P ThreatIntelSet
	props := &ThreatIntelSet{}
	newProps := &struct {
		*P
		DetectorId types.StringIsh `json:"DetectorId,omitempty"`
		Format     types.StringIsh `json:"Format,omitempty"`
		Location   types.StringIsh `json:"Location,omitempty"`
	...
	if res.Properties != nil {
		...
		props.Format = string(newProps.Format)
		props.Location = string(newProps.Location)
