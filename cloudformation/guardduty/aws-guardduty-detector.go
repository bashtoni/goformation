...
func (r *Detector) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		FindingPublishingFrequency types.StringIsh `json:"FindingPublishingFrequency,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.FindingPublishingFrequency = string(newProps.FindingPublishingFrequency)
