...
func (r *DetectorModel) UnmarshalJSON(b []byte) error {
	type P DetectorModel
	props := &DetectorModel{}
	newProps := &struct {
		*P
		DetectorModelDescription types.StringIsh `json:"DetectorModelDescription,omitempty"`
		DetectorModelName        types.StringIsh `json:"DetectorModelName,omitempty"`
		EvaluationMethod         types.StringIsh `json:"EvaluationMethod,omitempty"`
	...
	if res.Properties != nil {
		...
		props.DetectorModelDescription = string(newProps.DetectorModelDescription)
		props.DetectorModelName = string(newProps.DetectorModelName)
		props.EvaluationMethod = string(newProps.EvaluationMethod)
