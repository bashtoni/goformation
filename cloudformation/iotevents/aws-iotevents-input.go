...
func (r *Input) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		InputDescription types.StringIsh `json:"InputDescription,omitempty"`
		InputName        types.StringIsh `json:"InputName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.InputDescription = string(newProps.InputDescription)
		props.InputName = string(newProps.InputName)
