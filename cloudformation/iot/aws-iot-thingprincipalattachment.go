...
func (r *ThingPrincipalAttachment) UnmarshalJSON(b []byte) error {
	type P ThingPrincipalAttachment
	props := &ThingPrincipalAttachment{}
	newProps := &struct {
		*P
		Principal types.StringIsh `json:"Principal,omitempty"`
		ThingName types.StringIsh `json:"ThingName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ThingName = string(newProps.ThingName)
