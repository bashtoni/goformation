...
func (r *WebACLAssociation) UnmarshalJSON(b []byte) error {
	type P WebACLAssociation
	props := &WebACLAssociation{}
	newProps := &struct {
		*P
		ResourceArn types.StringIsh `json:"ResourceArn,omitempty"`
		WebACLArn   types.StringIsh `json:"WebACLArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ResourceArn = string(newProps.ResourceArn)
		props.WebACLArn = string(newProps.WebACLArn)
