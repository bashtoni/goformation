...
func (r *Application) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		OpsItemSNSTopicArn types.StringIsh `json:"OpsItemSNSTopicArn,omitempty"`
		ResourceGroupName  types.StringIsh `json:"ResourceGroupName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.OpsItemSNSTopicArn = string(newProps.OpsItemSNSTopicArn)
		props.ResourceGroupName = string(newProps.ResourceGroupName)
