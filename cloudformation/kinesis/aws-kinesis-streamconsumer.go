...
func (r *StreamConsumer) UnmarshalJSON(b []byte) error {
	type P StreamConsumer
	props := &StreamConsumer{}
	newProps := &struct {
		*P
		ConsumerName types.StringIsh `json:"ConsumerName,omitempty"`
		StreamARN    types.StringIsh `json:"StreamARN,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConsumerName = string(newProps.ConsumerName)
		props.StreamARN = string(newProps.StreamARN)
