...
func (r *MatchmakingConfiguration) UnmarshalJSON(b []byte) error {
	type P MatchmakingConfiguration
	props := &MatchmakingConfiguration{}
	newProps := &struct {
		*P
		BackfillMode       types.StringIsh `json:"BackfillMode,omitempty"`
		CustomEventData    types.StringIsh `json:"CustomEventData,omitempty"`
		Description        types.StringIsh `json:"Description,omitempty"`
		GameSessionData    types.StringIsh `json:"GameSessionData,omitempty"`
		Name               types.StringIsh `json:"Name,omitempty"`
		NotificationTarget types.StringIsh `json:"NotificationTarget,omitempty"`
		RuleSetName        types.StringIsh `json:"RuleSetName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.BackfillMode = string(newProps.BackfillMode)
		props.CustomEventData = string(newProps.CustomEventData)
		props.Description = string(newProps.Description)
		props.GameSessionData = string(newProps.GameSessionData)
		props.Name = string(newProps.Name)
		props.NotificationTarget = string(newProps.NotificationTarget)
		props.RuleSetName = string(newProps.RuleSetName)
