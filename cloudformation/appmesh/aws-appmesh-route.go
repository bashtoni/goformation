...
func (r *Route) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		RouteName         types.StringIsh `json:"RouteName,omitempty"`
		VirtualRouterName types.StringIsh `json:"VirtualRouterName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.RouteName = string(newProps.RouteName)
		props.VirtualRouterName = string(newProps.VirtualRouterName)
