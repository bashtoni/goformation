...
func (r *CustomerGatewayAssociation) UnmarshalJSON(b []byte) error {
	type P CustomerGatewayAssociation
	props := &CustomerGatewayAssociation{}
	newProps := &struct {
		*P
		CustomerGatewayArn types.StringIsh `json:"CustomerGatewayArn,omitempty"`
		DeviceId           types.StringIsh `json:"DeviceId,omitempty"`
		GlobalNetworkId    types.StringIsh `json:"GlobalNetworkId,omitempty"`
		LinkId             types.StringIsh `json:"LinkId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.CustomerGatewayArn = string(newProps.CustomerGatewayArn)
		props.DeviceId = string(newProps.DeviceId)
		props.GlobalNetworkId = string(newProps.GlobalNetworkId)
		props.LinkId = string(newProps.LinkId)
