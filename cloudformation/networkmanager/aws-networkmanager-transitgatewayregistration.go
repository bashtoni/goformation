...
func (r *TransitGatewayRegistration) UnmarshalJSON(b []byte) error {
	type P TransitGatewayRegistration
	props := &TransitGatewayRegistration{}
	newProps := &struct {
		*P
		GlobalNetworkId   types.StringIsh `json:"GlobalNetworkId,omitempty"`
		TransitGatewayArn types.StringIsh `json:"TransitGatewayArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.TransitGatewayArn = string(newProps.TransitGatewayArn)
