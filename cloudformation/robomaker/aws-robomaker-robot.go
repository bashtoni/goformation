...
func (r *Robot) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		Fleet             types.StringIsh `json:"Fleet,omitempty"`
		GreengrassGroupId types.StringIsh `json:"GreengrassGroupId,omitempty"`
	...
	if res.Properties != nil {
		...
		props.Fleet = string(newProps.Fleet)
		props.GreengrassGroupId = string(newProps.GreengrassGroupId)
