...
func (r *SimulationApplicationVersion) UnmarshalJSON(b []byte) error {
	type P SimulationApplicationVersion
	props := &SimulationApplicationVersion{}
	newProps := &struct {
		*P
		Application       types.StringIsh `json:"Application,omitempty"`
		CurrentRevisionId types.StringIsh `json:"CurrentRevisionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.Application = string(newProps.Application)
		props.CurrentRevisionId = string(newProps.CurrentRevisionId)
