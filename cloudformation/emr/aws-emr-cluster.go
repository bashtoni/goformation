...
func (r *Cluster) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		AutoScalingRole       types.StringIsh `json:"AutoScalingRole,omitempty"`
		CustomAmiId           types.StringIsh `json:"CustomAmiId,omitempty"`
		JobFlowRole           types.StringIsh `json:"JobFlowRole,omitempty"`
		LogUri                types.StringIsh `json:"LogUri,omitempty"`
		Name                  types.StringIsh `json:"Name,omitempty"`
		ReleaseLabel          types.StringIsh `json:"ReleaseLabel,omitempty"`
		ScaleDownBehavior     types.StringIsh `json:"ScaleDownBehavior,omitempty"`
	...
	if res.Properties != nil {
		...
		props.AutoScalingRole = string(newProps.AutoScalingRole)
		props.CustomAmiId = string(newProps.CustomAmiId)
		props.JobFlowRole = string(newProps.JobFlowRole)
		props.LogUri = string(newProps.LogUri)
		props.Name = string(newProps.Name)
		props.ReleaseLabel = string(newProps.ReleaseLabel)
		props.ScaleDownBehavior = string(newProps.ScaleDownBehavior)
