...
func (r *InstanceGroupConfig) UnmarshalJSON(b []byte) error {
	type P InstanceGroupConfig
	props := &InstanceGroupConfig{}
	newProps := &struct {
		*P
		BidPrice     types.StringIsh `json:"BidPrice,omitempty"`
		InstanceRole types.StringIsh `json:"InstanceRole,omitempty"`
		InstanceType types.StringIsh `json:"InstanceType,omitempty"`
		JobFlowId    types.StringIsh `json:"JobFlowId,omitempty"`
		Market       types.StringIsh `json:"Market,omitempty"`
	...
	if res.Properties != nil {
		...
		props.BidPrice = string(newProps.BidPrice)
		props.InstanceRole = string(newProps.InstanceRole)
		props.InstanceType = string(newProps.InstanceType)
		props.JobFlowId = string(newProps.JobFlowId)
		props.Market = string(newProps.Market)
