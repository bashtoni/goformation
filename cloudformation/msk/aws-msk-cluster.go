...
func (r *Cluster) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		EnhancedMonitoring types.StringIsh `json:"EnhancedMonitoring,omitempty"`
		KafkaVersion       types.StringIsh `json:"KafkaVersion,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.EnhancedMonitoring = string(newProps.EnhancedMonitoring)
		props.KafkaVersion = string(newProps.KafkaVersion)
