...
func (r *MemberInvitation) UnmarshalJSON(b []byte) error {
	type P MemberInvitation
	props := &MemberInvitation{}
	newProps := &struct {
		*P
		GraphArn           types.StringIsh `json:"GraphArn,omitempty"`
		MemberEmailAddress types.StringIsh `json:"MemberEmailAddress,omitempty"`
	...
	if res.Properties != nil {
		...
		props.GraphArn = string(newProps.GraphArn)
		props.MemberEmailAddress = string(newProps.MemberEmailAddress)
