...
func (r *Volume) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		OutpostArn       types.StringIsh `json:"OutpostArn,omitempty"`
		SnapshotId       types.StringIsh `json:"SnapshotId,omitempty"`
		VolumeType       types.StringIsh `json:"VolumeType,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.OutpostArn = string(newProps.OutpostArn)
		props.SnapshotId = string(newProps.SnapshotId)
		props.VolumeType = string(newProps.VolumeType)
