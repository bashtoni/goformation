...
func (r *TrafficMirrorTarget) UnmarshalJSON(b []byte) error {
	type P TrafficMirrorTarget
	props := &TrafficMirrorTarget{}
	newProps := &struct {
		*P
		...
		NetworkLoadBalancerArn types.StringIsh `json:"NetworkLoadBalancerArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.NetworkLoadBalancerArn = string(newProps.NetworkLoadBalancerArn)
