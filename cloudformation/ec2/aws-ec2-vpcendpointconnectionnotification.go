...
func (r *VPCEndpointConnectionNotification) UnmarshalJSON(b []byte) error {
	type P VPCEndpointConnectionNotification
	props := &VPCEndpointConnectionNotification{}
	newProps := &struct {
		*P
		ConnectionNotificationArn types.StringIsh `json:"ConnectionNotificationArn,omitempty"`
		ServiceId                 types.StringIsh `json:"ServiceId,omitempty"`
		VPCEndpointId             types.StringIsh `json:"VPCEndpointId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConnectionNotificationArn = string(newProps.ConnectionNotificationArn)
		props.ServiceId = string(newProps.ServiceId)
		props.VPCEndpointId = string(newProps.VPCEndpointId)
