...
func (r *ClientVpnAuthorizationRule) UnmarshalJSON(b []byte) error {
	type P ClientVpnAuthorizationRule
	props := &ClientVpnAuthorizationRule{}
	newProps := &struct {
		*P
		AccessGroupId       types.StringIsh `json:"AccessGroupId,omitempty"`
		...
		TargetNetworkCidr   types.StringIsh `json:"TargetNetworkCidr,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AccessGroupId = string(newProps.AccessGroupId)
		props.ClientVpnEndpointId = string(newProps.ClientVpnEndpointId)
		props.Description = string(newProps.Description)
		props.TargetNetworkCidr = string(newProps.TargetNetworkCidr)
