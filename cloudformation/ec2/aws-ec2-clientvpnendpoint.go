...
func (r *ClientVpnEndpoint) UnmarshalJSON(b []byte) error {
	type P ClientVpnEndpoint
	props := &ClientVpnEndpoint{}
	newProps := &struct {
		*P
		ClientCidrBlock      types.StringIsh `json:"ClientCidrBlock,omitempty"`
		Description          types.StringIsh `json:"Description,omitempty"`
		ServerCertificateArn types.StringIsh `json:"ServerCertificateArn,omitempty"`
		TransportProtocol    types.StringIsh `json:"TransportProtocol,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ClientCidrBlock = string(newProps.ClientCidrBlock)
		props.Description = string(newProps.Description)
		props.ServerCertificateArn = string(newProps.ServerCertificateArn)
		props.TransportProtocol = string(newProps.TransportProtocol)
