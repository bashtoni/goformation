...
func (r *TrafficMirrorSession) UnmarshalJSON(b []byte) error {
	type P TrafficMirrorSession
	props := &TrafficMirrorSession{}
	newProps := &struct {
		*P
		...
		TrafficMirrorTargetId types.StringIsh `json:"TrafficMirrorTargetId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.TrafficMirrorTargetId = string(newProps.TrafficMirrorTargetId)
