...
func (r *ClientVpnRoute) UnmarshalJSON(b []byte) error {
	type P ClientVpnRoute
	props := &ClientVpnRoute{}
	newProps := &struct {
		*P
		ClientVpnEndpointId  types.StringIsh `json:"ClientVpnEndpointId,omitempty"`
		...
		TargetVpcSubnetId    types.StringIsh `json:"TargetVpcSubnetId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ClientVpnEndpointId = string(newProps.ClientVpnEndpointId)
		props.Description = string(newProps.Description)
		props.DestinationCidrBlock = string(newProps.DestinationCidrBlock)
		props.TargetVpcSubnetId = string(newProps.TargetVpcSubnetId)
