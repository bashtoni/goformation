...
func (r *VPNConnectionRoute) UnmarshalJSON(b []byte) error {
	type P VPNConnectionRoute
	props := &VPNConnectionRoute{}
	newProps := &struct {
		*P
		DestinationCidrBlock types.StringIsh `json:"DestinationCidrBlock,omitempty"`
		VpnConnectionId      types.StringIsh `json:"VpnConnectionId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.VpnConnectionId = string(newProps.VpnConnectionId)
