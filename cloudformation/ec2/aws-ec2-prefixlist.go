...
func (r *PrefixList) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		AddressFamily  types.StringIsh `json:"AddressFamily,omitempty"`
		PrefixListName types.StringIsh `json:"PrefixListName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AddressFamily = string(newProps.AddressFamily)
		props.PrefixListName = string(newProps.PrefixListName)
