...
func (r *TrafficMirrorFilterRule) UnmarshalJSON(b []byte) error {
	type P TrafficMirrorFilterRule
	props := &TrafficMirrorFilterRule{}
	newProps := &struct {
		*P
		...
		RuleAction            types.StringIsh `json:"RuleAction,omitempty"`
		SourceCidrBlock       types.StringIsh `json:"SourceCidrBlock,omitempty"`
		TrafficDirection      types.StringIsh `json:"TrafficDirection,omitempty"`
		TrafficMirrorFilterId types.StringIsh `json:"TrafficMirrorFilterId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.RuleAction = string(newProps.RuleAction)
		props.SourceCidrBlock = string(newProps.SourceCidrBlock)
		props.TrafficDirection = string(newProps.TrafficDirection)
		props.TrafficMirrorFilterId = string(newProps.TrafficMirrorFilterId)
