...
func (r *LocalGatewayRoute) UnmarshalJSON(b []byte) error {
	type P LocalGatewayRoute
	props := &LocalGatewayRoute{}
	newProps := &struct {
		*P
		DestinationCidrBlock                types.StringIsh `json:"DestinationCidrBlock,omitempty"`
		LocalGatewayRouteTableId            types.StringIsh `json:"LocalGatewayRouteTableId,omitempty"`
		LocalGatewayVirtualInterfaceGroupId types.StringIsh `json:"LocalGatewayVirtualInterfaceGroupId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.LocalGatewayRouteTableId = string(newProps.LocalGatewayRouteTableId)
		props.LocalGatewayVirtualInterfaceGroupId = string(newProps.LocalGatewayVirtualInterfaceGroupId)
