...
func (r *NetworkInterfacePermission) UnmarshalJSON(b []byte) error {
	type P NetworkInterfacePermission
	props := &NetworkInterfacePermission{}
	newProps := &struct {
		*P
		AwsAccountId       types.StringIsh `json:"AwsAccountId,omitempty"`
		NetworkInterfaceId types.StringIsh `json:"NetworkInterfaceId,omitempty"`
		Permission         types.StringIsh `json:"Permission,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AwsAccountId = string(newProps.AwsAccountId)
		props.NetworkInterfaceId = string(newProps.NetworkInterfaceId)
		props.Permission = string(newProps.Permission)
