...
func (r *CapacityReservation) UnmarshalJSON(b []byte) error {
	type P CapacityReservation
	props := &CapacityReservation{}
	newProps := &struct {
		*P
		AvailabilityZone      types.StringIsh `json:"AvailabilityZone,omitempty"`
		EndDate               types.StringIsh `json:"EndDate,omitempty"`
		EndDateType           types.StringIsh `json:"EndDateType,omitempty"`
		InstanceMatchCriteria types.StringIsh `json:"InstanceMatchCriteria,omitempty"`
		InstancePlatform      types.StringIsh `json:"InstancePlatform,omitempty"`
	...
	if res.Properties != nil {
		...
		props.EndDate = string(newProps.EndDate)
		props.EndDateType = string(newProps.EndDateType)
		props.InstanceMatchCriteria = string(newProps.InstanceMatchCriteria)
		props.InstancePlatform = string(newProps.InstancePlatform)
