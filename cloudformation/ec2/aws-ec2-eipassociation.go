...
func (r *EIPAssociation) UnmarshalJSON(b []byte) error {
	type P EIPAssociation
	props := &EIPAssociation{}
	newProps := &struct {
		*P
		AllocationId       types.StringIsh `json:"AllocationId,omitempty"`
		EIP                types.StringIsh `json:"EIP,omitempty"`
	...
	if res.Properties != nil {
		...
		props.AllocationId = string(newProps.AllocationId)
		props.EIP = string(newProps.EIP)
