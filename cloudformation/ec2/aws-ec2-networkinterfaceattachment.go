...
func (r *NetworkInterfaceAttachment) UnmarshalJSON(b []byte) error {
	type P NetworkInterfaceAttachment
	props := &NetworkInterfaceAttachment{}
	newProps := &struct {
		*P
		DeviceIndex        types.StringIsh `json:"DeviceIndex,omitempty"`
	...
	if res.Properties != nil {
		...
		props.DeviceIndex = string(newProps.DeviceIndex)
