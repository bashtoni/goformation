...
func (r *VPCDHCPOptionsAssociation) UnmarshalJSON(b []byte) error {
	type P VPCDHCPOptionsAssociation
	props := &VPCDHCPOptionsAssociation{}
	newProps := &struct {
		*P
		DhcpOptionsId types.StringIsh `json:"DhcpOptionsId,omitempty"`
	...
	if res.Properties != nil {
		...
		props.DhcpOptionsId = string(newProps.DhcpOptionsId)
