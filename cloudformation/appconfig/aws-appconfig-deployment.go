...
func (r *Deployment) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		ConfigurationProfileId types.StringIsh `json:"ConfigurationProfileId,omitempty"`
		ConfigurationVersion   types.StringIsh `json:"ConfigurationVersion,omitempty"`
		DeploymentStrategyId   types.StringIsh `json:"DeploymentStrategyId,omitempty"`
		Description            types.StringIsh `json:"Description,omitempty"`
		EnvironmentId          types.StringIsh `json:"EnvironmentId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConfigurationProfileId = string(newProps.ConfigurationProfileId)
		props.ConfigurationVersion = string(newProps.ConfigurationVersion)
		props.DeploymentStrategyId = string(newProps.DeploymentStrategyId)
		props.Description = string(newProps.Description)
		props.EnvironmentId = string(newProps.EnvironmentId)
