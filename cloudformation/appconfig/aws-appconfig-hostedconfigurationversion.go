...
func (r *HostedConfigurationVersion) UnmarshalJSON(b []byte) error {
	type P HostedConfigurationVersion
	props := &HostedConfigurationVersion{}
	newProps := &struct {
		*P
		...
		ContentType            types.StringIsh `json:"ContentType,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ContentType = string(newProps.ContentType)
