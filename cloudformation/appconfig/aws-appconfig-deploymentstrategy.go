...
func (r *DeploymentStrategy) UnmarshalJSON(b []byte) error {
	type P DeploymentStrategy
	props := &DeploymentStrategy{}
	newProps := &struct {
		*P
		Description types.StringIsh `json:"Description,omitempty"`
		GrowthType  types.StringIsh `json:"GrowthType,omitempty"`
		Name        types.StringIsh `json:"Name,omitempty"`
		ReplicateTo types.StringIsh `json:"ReplicateTo,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.GrowthType = string(newProps.GrowthType)
		props.Name = string(newProps.Name)
		props.ReplicateTo = string(newProps.ReplicateTo)
