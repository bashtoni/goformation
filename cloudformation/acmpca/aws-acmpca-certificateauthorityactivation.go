...
func (r *CertificateAuthorityActivation) UnmarshalJSON(b []byte) error {
	type P CertificateAuthorityActivation
	props := &CertificateAuthorityActivation{}
	newProps := &struct {
		*P
		...
		CertificateChain        types.StringIsh `json:"CertificateChain,omitempty"`
	...
	if res.Properties != nil {
		...
		props.CertificateChain = string(newProps.CertificateChain)
