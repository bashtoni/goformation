...
func (r *User) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		HomeDirectory     types.StringIsh `json:"HomeDirectory,omitempty"`
		HomeDirectoryType types.StringIsh `json:"HomeDirectoryType,omitempty"`
		Policy            types.StringIsh `json:"Policy,omitempty"`
		Role              types.StringIsh `json:"Role,omitempty"`
		ServerId          types.StringIsh `json:"ServerId,omitempty"`
	...
	if res.Properties != nil {
		...
		props.HomeDirectory = string(newProps.HomeDirectory)
		props.HomeDirectoryType = string(newProps.HomeDirectoryType)
		props.Policy = string(newProps.Policy)
		props.Role = string(newProps.Role)
		props.ServerId = string(newProps.ServerId)
