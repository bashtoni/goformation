...
func (r *Service) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		Cluster            types.StringIsh `json:"Cluster,omitempty"`
		LaunchType         types.StringIsh `json:"LaunchType,omitempty"`
		PlatformVersion    types.StringIsh `json:"PlatformVersion,omitempty"`
		PropagateTags      types.StringIsh `json:"PropagateTags,omitempty"`
		Role               types.StringIsh `json:"Role,omitempty"`
		SchedulingStrategy types.StringIsh `json:"SchedulingStrategy,omitempty"`
		ServiceName        types.StringIsh `json:"ServiceName,omitempty"`
		TaskDefinition     types.StringIsh `json:"TaskDefinition,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.Cluster = string(newProps.Cluster)
		props.LaunchType = string(newProps.LaunchType)
		props.PlatformVersion = string(newProps.PlatformVersion)
		props.PropagateTags = string(newProps.PropagateTags)
		props.Role = string(newProps.Role)
		props.SchedulingStrategy = string(newProps.SchedulingStrategy)
		props.ServiceName = string(newProps.ServiceName)
		props.TaskDefinition = string(newProps.TaskDefinition)
