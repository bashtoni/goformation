...
func (r *AssessmentTemplate) UnmarshalJSON(b []byte) error {
	type P AssessmentTemplate
	props := &AssessmentTemplate{}
	newProps := &struct {
		*P
		AssessmentTargetArn    types.StringIsh `json:"AssessmentTargetArn,omitempty"`
		AssessmentTemplateName types.StringIsh `json:"AssessmentTemplateName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AssessmentTargetArn = string(newProps.AssessmentTargetArn)
		props.AssessmentTemplateName = string(newProps.AssessmentTemplateName)
