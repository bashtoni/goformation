...
func (r *AssessmentTarget) UnmarshalJSON(b []byte) error {
	type P AssessmentTarget
	props := &AssessmentTarget{}
	newProps := &struct {
		*P
		AssessmentTargetName types.StringIsh `json:"AssessmentTargetName,omitempty"`
		ResourceGroupArn     types.StringIsh `json:"ResourceGroupArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AssessmentTargetName = string(newProps.AssessmentTargetName)
		props.ResourceGroupArn = string(newProps.ResourceGroupArn)
