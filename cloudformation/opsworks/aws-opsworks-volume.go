...
func (r *Volume) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		Ec2VolumeId types.StringIsh `json:"Ec2VolumeId,omitempty"`
		MountPoint  types.StringIsh `json:"MountPoint,omitempty"`
	...
	if res.Properties != nil {
		...
		props.Ec2VolumeId = string(newProps.Ec2VolumeId)
		props.MountPoint = string(newProps.MountPoint)
