...
func (r *UserProfile) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		IamUserArn   types.StringIsh `json:"IamUserArn,omitempty"`
		SshPublicKey types.StringIsh `json:"SshPublicKey,omitempty"`
		SshUsername  types.StringIsh `json:"SshUsername,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.IamUserArn = string(newProps.IamUserArn)
		props.SshPublicKey = string(newProps.SshPublicKey)
		props.SshUsername = string(newProps.SshUsername)
