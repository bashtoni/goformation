...
func (r *ElasticLoadBalancerAttachment) UnmarshalJSON(b []byte) error {
	type P ElasticLoadBalancerAttachment
	props := &ElasticLoadBalancerAttachment{}
	newProps := &struct {
		*P
		ElasticLoadBalancerName types.StringIsh `json:"ElasticLoadBalancerName,omitempty"`
		LayerId                 types.StringIsh `json:"LayerId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ElasticLoadBalancerName = string(newProps.ElasticLoadBalancerName)
		props.LayerId = string(newProps.LayerId)
