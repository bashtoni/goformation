...
func (r *ResolverRuleAssociation) UnmarshalJSON(b []byte) error {
	type P ResolverRuleAssociation
	props := &ResolverRuleAssociation{}
	newProps := &struct {
		*P
		Name           types.StringIsh `json:"Name,omitempty"`
		ResolverRuleId types.StringIsh `json:"ResolverRuleId,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ResolverRuleId = string(newProps.ResolverRuleId)
