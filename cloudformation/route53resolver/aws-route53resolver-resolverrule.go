...
func (r *ResolverRule) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		ResolverEndpointId types.StringIsh `json:"ResolverEndpointId,omitempty"`
		RuleType           types.StringIsh `json:"RuleType,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ResolverEndpointId = string(newProps.ResolverEndpointId)
		props.RuleType = string(newProps.RuleType)
