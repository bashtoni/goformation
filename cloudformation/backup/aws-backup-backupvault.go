...
func (r *BackupVault) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		BackupVaultName  types.StringIsh `json:"BackupVaultName,omitempty"`
		EncryptionKeyArn types.StringIsh `json:"EncryptionKeyArn,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.BackupVaultName = string(newProps.BackupVaultName)
		props.EncryptionKeyArn = string(newProps.EncryptionKeyArn)
