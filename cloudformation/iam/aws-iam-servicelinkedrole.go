...
func (r *ServiceLinkedRole) UnmarshalJSON(b []byte) error {
	type P ServiceLinkedRole
	props := &ServiceLinkedRole{}
	newProps := &struct {
		*P
		AWSServiceName types.StringIsh `json:"AWSServiceName,omitempty"`
		CustomSuffix   types.StringIsh `json:"CustomSuffix,omitempty"`
	...
	if res.Properties != nil {
		...
		props.AWSServiceName = string(newProps.AWSServiceName)
		props.CustomSuffix = string(newProps.CustomSuffix)
