...
func (r *SlackChannelConfiguration) UnmarshalJSON(b []byte) error {
	type P SlackChannelConfiguration
	props := &SlackChannelConfiguration{}
	newProps := &struct {
		*P
		ConfigurationName types.StringIsh `json:"ConfigurationName,omitempty"`
		IamRoleArn        types.StringIsh `json:"IamRoleArn,omitempty"`
		LoggingLevel      types.StringIsh `json:"LoggingLevel,omitempty"`
		SlackChannelId    types.StringIsh `json:"SlackChannelId,omitempty"`
		SlackWorkspaceId  types.StringIsh `json:"SlackWorkspaceId,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ConfigurationName = string(newProps.ConfigurationName)
		props.IamRoleArn = string(newProps.IamRoleArn)
		props.LoggingLevel = string(newProps.LoggingLevel)
		props.SlackChannelId = string(newProps.SlackChannelId)
		props.SlackWorkspaceId = string(newProps.SlackWorkspaceId)
