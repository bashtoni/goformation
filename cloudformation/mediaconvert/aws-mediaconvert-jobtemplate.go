...
func (r *JobTemplate) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		Category             types.StringIsh `json:"Category,omitempty"`
		Description          types.StringIsh `json:"Description,omitempty"`
		Name                 types.StringIsh `json:"Name,omitempty"`
		Queue                types.StringIsh `json:"Queue,omitempty"`
		StatusUpdateInterval types.StringIsh `json:"StatusUpdateInterval,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.Category = string(newProps.Category)
		props.Description = string(newProps.Description)
		props.Name = string(newProps.Name)
		props.Queue = string(newProps.Queue)
		props.StatusUpdateInterval = string(newProps.StatusUpdateInterval)
