...
func (r *RestApi) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ApiKeySourceType types.StringIsh `json:"ApiKeySourceType,omitempty"`
		CloneFrom        types.StringIsh `json:"CloneFrom,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ApiKeySourceType = string(newProps.ApiKeySourceType)
		props.CloneFrom = string(newProps.CloneFrom)
