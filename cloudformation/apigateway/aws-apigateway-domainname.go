...
func (r *DomainName) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		...
		RegionalCertificateArn types.StringIsh `json:"RegionalCertificateArn,omitempty"`
		SecurityPolicy         types.StringIsh `json:"SecurityPolicy,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.RegionalCertificateArn = string(newProps.RegionalCertificateArn)
		props.SecurityPolicy = string(newProps.SecurityPolicy)
