...
func (r *GatewayResponse) UnmarshalJSON(b []byte) error {
	type P GatewayResponse
	props := &GatewayResponse{}
	newProps := &struct {
		*P
		ResponseType types.StringIsh `json:"ResponseType,omitempty"`
		RestApiId    types.StringIsh `json:"RestApiId,omitempty"`
		StatusCode   types.StringIsh `json:"StatusCode,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.ResponseType = string(newProps.ResponseType)
		props.RestApiId = string(newProps.RestApiId)
		props.StatusCode = string(newProps.StatusCode)
