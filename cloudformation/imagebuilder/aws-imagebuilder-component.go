...
func (r *Component) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		ChangeDescription types.StringIsh `json:"ChangeDescription,omitempty"`
		Data              types.StringIsh `json:"Data,omitempty"`
		...
		Platform          types.StringIsh `json:"Platform,omitempty"`
		Uri               types.StringIsh `json:"Uri,omitempty"`
	...
	if res.Properties != nil {
		...
		props.ChangeDescription = string(newProps.ChangeDescription)
		props.Data = string(newProps.Data)
		props.Description = string(newProps.Description)
		props.KmsKeyId = string(newProps.KmsKeyId)
		props.Name = string(newProps.Name)
		props.Platform = string(newProps.Platform)
		props.Uri = string(newProps.Uri)
