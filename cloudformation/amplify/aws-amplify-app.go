...
func (r *App) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		AccessToken    types.StringIsh `json:"AccessToken,omitempty"`
		BuildSpec      types.StringIsh `json:"BuildSpec,omitempty"`
		Description    types.StringIsh `json:"Description,omitempty"`
		IAMServiceRole types.StringIsh `json:"IAMServiceRole,omitempty"`
		Name           types.StringIsh `json:"Name,omitempty"`
		OauthToken     types.StringIsh `json:"OauthToken,omitempty"`
		Repository     types.StringIsh `json:"Repository,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.AccessToken = string(newProps.AccessToken)
		props.BuildSpec = string(newProps.BuildSpec)
		props.Description = string(newProps.Description)
		props.IAMServiceRole = string(newProps.IAMServiceRole)
		props.Name = string(newProps.Name)
		props.OauthToken = string(newProps.OauthToken)
		props.Repository = string(newProps.Repository)
