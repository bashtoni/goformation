...
func (r *Table) UnmarshalJSON(b []byte) error {
	...
	newProps := &struct {
		*P
		KeyspaceName types.StringIsh `json:"KeyspaceName,omitempty"`
		TableName    types.StringIsh `json:"TableName,omitempty"`
	}{P: (*P)(props)}
	res := &struct {
		Type                string
	...
	if res.Properties != nil {
		...
		props.KeyspaceName = string(newProps.KeyspaceName)
		props.TableName = string(newProps.TableName)
